...
typedef ngx_int_t (*ngx_http_live_netcall_sink_pt)(ngx_http_request_t *r,ngx_chain_t *in);
typedef ngx_int_t (*ngx_http_live_netcall_handle_pt)(ngx_http_request_t *r,void *arg, ngx_chain_t *in);
